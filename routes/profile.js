...
router.post('/', (req, res) => {
  try {
    const { userEmail, idNumber, caseNumber, phoneNumber, govToken, geminiApiKey } = req.body;
    ...
    const newUserData = { userEmail, idNumber, caseNumber, phoneNumber, govToken, geminiApiKey };
