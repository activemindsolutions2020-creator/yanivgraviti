...
- **Automatic Deployment:** Always commit and push code updates to Git/GitHub after changes are verified, so they are automatically deployed to the server (Render) immediately. Do not wait for manual instructions to push.